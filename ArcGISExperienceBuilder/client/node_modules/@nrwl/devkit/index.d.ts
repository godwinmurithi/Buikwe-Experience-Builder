...
export { readNxJson, readAllWorkspaceConfiguration, workspaceLayout, } from 'nx/src/project-graph/file-utils';
 ...
 * @category Generators
 */
export { addProjectConfiguration, readProjectConfiguration, removeProjectConfiguration, updateProjectConfiguration, readWorkspaceConfiguration, updateWorkspaceConfiguration, getProjects, isStandaloneProject, } from 'nx/src/generators/utils/project-configuration';
/**
 * @category Generators
 */
 ...
 */
export type { ProjectFileMap, FileData, ProjectGraph, ProjectGraphV4, ProjectGraphDependency, ProjectGraphNode, ProjectGraphProjectNode, ProjectGraphExternalNode, ProjectGraphProcessorContext, } from 'nx/src/config/project-graph';
/**
 * @category Project Graph
 */
 ...
 * @category Utils
 */
export { addDependenciesToPackageJson, ensurePackage, removeDependenciesFromPackageJson, } from './src/utils/package-json';
/**
 * @category Utils
 */
 ...
 * @category Utils
 */
export { getWorkspaceLayout, getWorkspacePath, extractLayoutDirectory, } from './src/utils/get-workspace-layout';
/**
 * @category Utils
 */
