...
function createItemInFolder(requestOptions) {
    ...
    return helpers_1.determineOwner(requestOptions).then(function (owner) {
        ...
        if (requestOptions.params.extent && helpers_1.isBBox(requestOptions.params.extent)) {
            requestOptions.params.extent = helpers_1.bboxToString(requestOptions.params.extent);
        }
