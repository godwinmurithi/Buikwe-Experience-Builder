...
import { s as slotChangeHasAssignedElement, d as setRequestedIcon, t as toAriaBoolean, g as getSlotted } from './dom-8bd9a2e4.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentLoaded } from './loadable-53a96a9a.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-88b820ed.js';
...
import { K as KindIcons } from './resources-28d67c1d.js';
...
const Alert = class {
  ...
  render() {
    ...
    const closeButton = (h("button", { "aria-label": this.messages.close, class: "alert-close", onClick: this.closeAlert, ref: (el) => (this.closeButton = el), type: "button" }, h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" })));
