...
import { f as focusElement, g as getSlotted, t as toAriaBoolean } from './dom-8bd9a2e4.js';
import { d as debounce } from './debounce-7eda7983.js';
import { h, H as Host } from './index-6167ae21.js';
  ...
  return (h(Host, { "aria-busy": toAriaBoolean(loading), role: "menu", ...rest },
    h("section", null,
      ...
      h("header", { class: { [CSS$1.sticky]: true } },
        filterEnabled ? (h("calcite-filter", { "aria-label": filterPlaceholder, disabled: loading || disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, ref: setFilterEl, value: filterText })) : null,
