 ...
 * v1.0.7
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-6167ae21.js';
import { f as focusElement, v as nodeListToArray, w as getRootNode, g as getSlotted, s as slotChangeHasAssignedElement, b as getElementDir, t as toAriaBoolean, x as filterDirectChildren } from './dom-8bd9a2e4.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-0feaf92e.js';
import { u as updateHostInteraction } from './interactive-85bb17cd.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-dca8c4ff.js';
import { C as CSS_UTILITY } from './resources-186e0ad8.js';
import './guid-be5a0c2d.js';
import './observers-aab95813.js';
...
const TreeItem = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-expanded": this.hasChildren ? toAriaBoolean(isExpanded) : undefined, "aria-hidden": toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem" }, h("div", { class: { [CSS.itemExpanded]: isExpanded } }, h("div", { class: CSS.nodeAndActionsContainer }, h("div", { class: {
        ...
        [CSS_UTILITY.rtl]: rtl
      }, "data-selection-mode": this.selectionMode, ref: (el) => (this.defaultSlotWrapper = el) }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), h("div", { class: CSS.actionsEnd, hidden: !hasEndActions }, slotNode)), h("div", { class: {
        [CSS.childrenContainer]: true,
        [CSS_UTILITY.rtl]: rtl
      }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, ref: (el) => this.setTransitionEl(el), role: this.hasChildren ? "group" : undefined }, h("slot", { name: SLOTS.children })))));
  }
  setTransitionEl(el) {
