...
import { f as filter } from './filter-617a0a20.js';
import { v as nodeListToArray, i as isPrimaryPointerButton, t as toAriaBoolean, h as getElementProp, g as getSlotted } from './dom-8bd9a2e4.js';
import { d as defaultMenuPlacement, f as filterComputedPlacements, c as connectFloatingUI, u as updateAfterClose, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-b1d5fc62.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-9666b7af.js';
...
import { c as createObserver } from './observers-aab95813.js';
import { c as connectOpenCloseComponent, d as disconnectOpenCloseComponent } from './openCloseComponent-dca8c4ff.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-9d290ff1.js';
import { d as debounce } from './debounce-7eda7983.js';
...
const Combobox = class {
  ...
  render() {
    ...
    return (h(Host, { onClick: this.comboboxFocusHandler }, h("div", { "aria-autocomplete": "list", "aria-controls": `${listboxUidPrefix}${guid}`, "aria-expanded": toAriaBoolean(open), "aria-haspopup": "listbox", "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-live": "polite", "aria-owns": `${listboxUidPrefix}${guid}`, class: {
        wrapper: true,
