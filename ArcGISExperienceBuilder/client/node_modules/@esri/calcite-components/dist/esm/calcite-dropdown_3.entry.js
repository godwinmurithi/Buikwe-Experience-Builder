...
import { t as toAriaBoolean, i as isPrimaryPointerButton, u as focusElementInGroup, f as focusElement, h as getElementProp } from './dom-8bd9a2e4.js';
import { f as filterComputedPlacements, c as connectFloatingUI, d as defaultMenuPlacement, u as updateAfterClose, a as disconnectFloatingUI, F as FloatingCSS, r as reposition } from './floating-ui-b1d5fc62.js';
    ...
    const slottedContent = this.iconStart && this.iconEnd
      ...
      : this.iconStart
        ...
        : this.iconEnd
          ...
          : contentNode;
    const contentEl = !this.href ? (slottedContent) : (h("a", { "aria-label": this.label, class: CSS.link, href: this.href, ref: (el) => (this.childLink = el), rel: this.rel, tabIndex: -1, target: this.target }, slottedContent));
