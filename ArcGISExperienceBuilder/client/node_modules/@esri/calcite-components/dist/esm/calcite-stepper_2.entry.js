...
import { u as focusElementInGroup, h as getElementProp, t as toAriaBoolean } from './dom-8bd9a2e4.js';
...
const StepperItem = class {
  ...
  render() {
    return (h(Host, { "aria-expanded": toAriaBoolean(this.selected), onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, h("div", { class: "container" }, h("div", { class: "stepper-item-header", ref: (el) => (this.headerEl = el), tabIndex: 
