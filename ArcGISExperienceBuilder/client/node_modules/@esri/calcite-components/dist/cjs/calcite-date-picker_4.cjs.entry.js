...
const DatePickerMonth = class {
  ...
  renderDateDay(active, day, date, currentMonth, ref) {
    ...
    return (index.h("calcite-date-picker-day", { active: active, class: {
      ...
      }, currentMonth: currentMonth, day: day, disabled: !utils.inRange(date, this.min, this.max), endOfRange: this.isEndOfRange(date), highlighted: this.betweenSelectedRange(date), key: date.toDateString(), onCalciteDaySelect: this.daySelect, onCalciteInternalDayHover: this.dayHover, range: !!this.startDate && !!this.endDate && !utils.sameDate(this.startDate, this.endDate), rangeHover: this.isRangeHover(date), ref: (el) => {
