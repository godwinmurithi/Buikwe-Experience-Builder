...
const dom = require('./dom-1f61b001.js');
const conditionalSlot = require('./conditionalSlot-9cfea627.js');
const interactive = require('./interactive-864c5140.js');
const openCloseComponent = require('./openCloseComponent-b566840a.js');
const resources = require('./resources-c9182c3c.js');
require('./guid-624d4437.js');
require('./observers-915048e0.js');
...
const TreeItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-expanded": this.hasChildren ? dom.toAriaBoolean(isExpanded) : undefined, "aria-hidden": dom.toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : undefined, "calcite-hydrated-hidden": hidden, role: "treeitem" }, index.h("div", { class: { [CSS.itemExpanded]: isExpanded } }, index.h("div", { class: CSS.nodeAndActionsContainer }, index.h("div", { class: {
        ...
        [resources.CSS_UTILITY.rtl]: rtl
      }, "data-selection-mode": this.selectionMode, ref: (el) => (this.defaultSlotWrapper = el) }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), index.h("div", { class: CSS.actionsEnd, hidden: !hasEndActions }, slotNode)), index.h("div", { class: {
        [CSS.childrenContainer]: true,
        [resources.CSS_UTILITY.rtl]: rtl
      }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, ref: (el) => this.setTransitionEl(el), role: this.hasChildren ? "group" : undefined }, index.h("slot", { name: SLOTS.children })))));
  }
  setTransitionEl(el) {
