...
const StepperItem = class {
  ...
  render() {
    return (index.h(index.Host, { "aria-expanded": dom.toAriaBoolean(this.selected), onClick: this.handleItemClick, onKeyDown: this.keyDownHandler }, index.h("div", { class: "container" }, index.h("div", { class: "stepper-item-header", ref: (el) => (this.headerEl = el), tabIndex: 
