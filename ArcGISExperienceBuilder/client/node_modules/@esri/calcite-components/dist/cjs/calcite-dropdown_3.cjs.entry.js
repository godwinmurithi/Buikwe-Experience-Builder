...
const DropdownItem = class {
  ...
  render() {
    ...
    const iconStartEl = (index.h("calcite-icon", { class: CSS.iconStart, flipRtl: this.iconFlipRtl === "start" || this.iconFlipRtl === "both", icon: this.iconStart, scale: scale === "l" ? "m" : "s" }));
    const contentNode = (index.h("span", { class: CSS.itemContent }, index.h("slot", null)));
    const iconEndEl = (index.h("calcite-icon", { class: CSS.iconEnd, flipRtl: this.iconFlipRtl === "end" || this.iconFlipRtl === "both", icon: this.iconEnd, scale: scale === "l" ? "m" : "s" }));
    const slottedContent = this.iconStart && this.iconEnd
      ...
      : this.iconStart
        ...
        : this.iconEnd
          ...
          : contentNode;
    const contentEl = !this.href ? (slottedContent) : (index.h("a", { "aria-label": this.label, class: CSS.link, href: this.href, ref: (el) => (this.childLink = el), rel: this.rel, tabIndex: -1, target: this.target }, slottedContent));
    ...
    return (index.h(index.Host, { "aria-checked": itemAria, role: itemRole, tabindex: "0" }, index.h("div", { class: {
      ...
      } }, this.selectionMode !== "none" ? (index.h("calcite-icon", { class: CSS.icon, icon: this.selectionMode === "multiple" ? "check" : "bullet-point", scale: scale === "l" ? "m" : "s" })) : null, contentEl)));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
