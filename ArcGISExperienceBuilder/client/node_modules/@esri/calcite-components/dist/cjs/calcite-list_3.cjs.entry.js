...
const observers = require('./observers-915048e0.js');
const loadable = require('./loadable-ba12e859.js');
const debounce = require('./debounce-af5882c5.js');
...
const List = class {
  constructor(hostRef) {
    ...
    this.updateListItems = debounce.debounce(() => {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS$1.container }, loading ? index.h("calcite-scrim", { class: CSS$1.scrim, loading: loading }) : null, index.h("table", { "aria-busy": dom.toAriaBoolean(loading), "aria-label": label || "", class: CSS$1.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled ? (index.h("thead", null, index.h("tr", { class: { [CSS$1.sticky]: true } }, index.h("th", { colSpan: MAX_COLUMNS }, index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: loading || disabled, items: dataForFilter, onCalciteFilterChange: this.handleFilter, placeholder: filterPlaceholder, ref: (el) => (this.filterEl = el), value: filterText }))))) : null, index.h("tbody", { class: CSS$1.tableContainer }, index.h("slot", { onSlotchange: this.handleDefaultSlotChange })))));
  }
...
const ListItem = class {
  ...
  renderActionsStart() {
    ...
    return (index.h("td", { "aria-label": label, class: CSS$2.actionsStart, hidden: !hasActionsStart, key: "actions-start-container", ref: (el) => (this.actionsStartEl = el), role: "gridcell" }, index.h("slot", { name: SLOTS.actionsStart, onSlotchange: this.handleActionsStartSlotChange })));
  }
  renderActionsEnd() {
    const { label, hasActionsEnd } = this;
    return (index.h("td", { "aria-label": label, class: CSS$2.actionsEnd, hidden: !hasActionsEnd, key: "actions-end-container", ref: (el) => (this.actionsEndEl = el), role: "gridcell" }, index.h("slot", { name: SLOTS.actionsEnd, onSlotchange: this.handleActionsEndSlotChange })));
  }
  renderContentStart() {
