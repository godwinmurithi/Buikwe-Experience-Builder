...
const Heading = require('./Heading-dbdd4fe3.js');
...
const Popover = class {
  ...
  renderCloseButton() {
    ...
    return closable ? (index.h("div", { class: CSS.closeButtonContainer, key: CSS.closeButtonContainer }, index.h("calcite-action", { class: CSS.closeButton, onClick: this.hide, ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), scale: this.scale, text: messages.close }, index.h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : this.scale })))) : null;
  }
  renderHeader() {
  ...
  render() {
    ...
    const arrowNode = !pointerDisabled ? index.h("div", { class: CSS.arrow, ref: this.storeArrowEl }) : null;
