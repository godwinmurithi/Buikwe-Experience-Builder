...
const sortable_esm = require('./sortable.esm-911336b9.js');
...
const resources = require('./resources-50130a88.js');
  ...
  renderHandle() {
    ...
    if (icon === resources.ICON_TYPES.grip) {
      return (index.h("span", { class: {
        ...
        }, "data-js-handle": true, onBlur: this.handleBlur, onKeyDown: this.handleKeyDown, role: "button", tabindex: "0" }, index.h("calcite-icon", { flipRtl: iconFlipRtl, icon: ICONS.drag, scale: "s" })));
    }
  }
  render() {
