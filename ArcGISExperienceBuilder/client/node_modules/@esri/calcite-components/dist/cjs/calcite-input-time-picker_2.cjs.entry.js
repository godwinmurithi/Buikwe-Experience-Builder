...
const guid = require('./guid-624d4437.js');
...
const t9n = require('./t9n-e2509f8c.js');
require('./dom-1f61b001.js');
...
const TimePicker = class {
  constructor(hostRef) {
    ...
    this.setValuePart = (key, value, emit = true) => {
      ...
      this.localizedMeridiem = this.value
        ? localizeTimeStringToParts({ value: this.value, locale: locale$1, numberingSystem })
  ...
  render() {
    ...
    return (index.h("div", { class: {
        ...
        [CSS.input]: true,
        [CSS.hour]: true
      }, onFocus: this.focusHandler, onKeyDown: this.hourKeyDownHandler, ref: this.setHourEl, role: "spinbutton", tabIndex: 0 }, this.localizedHour || "--"), index.h("span", { "aria-label": this.messages.hourDown, class: {
        [CSS.button]: true,
        ...
        [CSS.input]: true,
        [CSS.minute]: true
      }, onFocus: this.focusHandler, onKeyDown: this.minuteKeyDownHandler, ref: this.setMinuteEl, role: "spinbutton", tabIndex: 0 }, this.localizedMinute || "--"), index.h("span", { "aria-label": this.messages.minuteDown, class: {
        [CSS.button]: true,
        ...
        [CSS.input]: true,
        [CSS.second]: true
      }, onFocus: this.focusHandler, onKeyDown: this.secondKeyDownHandler, ref: this.setSecondEl, role: "spinbutton", tabIndex: 0 }, this.localizedSecond || "--"), index.h("span", { "aria-label": this.messages.secondDown, class: {
        [CSS.button]: true,
        ...
        [CSS.input]: true,
        [CSS.meridiem]: true
      }, onFocus: this.focusHandler, onKeyDown: this.meridiemKeyDownHandler, ref: this.setMeridiemEl, role: "spinbutton", tabIndex: 0 }, this.localizedMeridiem || "--"), index.h("span", { "aria-label": this.messages.meridiemDown, class: {
        [CSS.button]: true,
