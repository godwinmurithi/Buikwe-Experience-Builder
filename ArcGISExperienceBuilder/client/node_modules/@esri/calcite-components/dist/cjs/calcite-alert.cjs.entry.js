...
const resources = require('./resources-16650b54.js');
...
const Alert = class {
  ...
  render() {
    ...
    const closeButton = (index.h("button", { "aria-label": this.messages.close, class: "alert-close", onClick: this.closeAlert, ref: (el) => (this.closeButton = el), type: "button" }, index.h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : "s" })));
