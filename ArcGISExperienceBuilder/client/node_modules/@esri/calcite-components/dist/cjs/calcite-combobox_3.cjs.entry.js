...
const filter = require('./filter-40ef5fb6.js');
...
const Combobox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.comboboxFocusHandler }, index.h("div", { "aria-autocomplete": "list", "aria-controls": `${listboxUidPrefix}${guid}`, "aria-expanded": dom.toAriaBoolean(open), "aria-haspopup": "listbox", "aria-labelledby": `${labelUidPrefix}${guid}`, "aria-live": "polite", "aria-owns": `${listboxUidPrefix}${guid}`, class: {
        wrapper: true,
