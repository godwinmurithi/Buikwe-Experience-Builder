import {
  ...
  MutableStoreManager,
  MessageDescription,
  FeatureDataRecord as FeatureQueryDataRecord
} from 'jimu-core'
      ...
      case MessageType.DataRecordsSelectionChange:
        ...
        if (record) {
          ...
          if (feature && feature.geometry?.type === 'polygon') {
            const geometry = feature.geometry as __esri.geometry.Polygon
            ...
            const selectedFeature = {
              ...
              displayName: feature.attributes[this.getLayerDisplayField(feature)]
            }
            ...
            const geometry = feature.geometry as __esri.geometry.Point
            ...
            if (geometry.latitude !== null && geometry.latitude !== null) {
              const selectedFeature = {
                ...
                spatial: geometry.spatialReference,
                attributes: feature.attributes ? feature.attributes : {},
                displayName: feature.attributes[this.getLayerDisplayField(feature)].toString()
              }
