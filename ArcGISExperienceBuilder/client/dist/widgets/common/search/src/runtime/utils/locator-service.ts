...
import { DataSourceStatus, FeatureLayerDataSource, QueriableDataSource, FieldSchema, Immutable } from 'jimu-core'
import { GeocodeList, GeocodeListItem, SuggestionItem, Suggestion, SearchResultView, RecordResultType } from '../../config'
