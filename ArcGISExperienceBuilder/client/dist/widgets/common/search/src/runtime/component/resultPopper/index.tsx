/** @jsx jsx */
import { Popper, TargetType, hooks } from 'jimu-ui'
import { React, jsx, classNames, ReactRedux, IMState, WidgetState } from 'jimu-core'
...
const ResultPopper = (props: Props) => {
  ...
  const { children, isOpen, reference, searchInputRef, autoFocus, className, isFocusWidtSearchInput, id, toggle } = props
