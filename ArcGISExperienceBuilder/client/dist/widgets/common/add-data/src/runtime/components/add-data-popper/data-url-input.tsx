/** @jsx jsx */
import { React, jsx, css, DataSourceJson, URIScheme, dataSourceUtils, esri, requestUtils, DataSourceTypes, ServiceManager, ServiceDefinition, SupportedLayerServiceTypes, classNames, defaultMessages as jimuCoreMessages } from 'jimu-core'
import { hooks, Button, defaultMessages as jimuUIMessages, Dropdown, DropdownButton, DropdownMenu, DropdownItem, UrlInput, ValidityResult, UrlInputResult, Loading, LoadingType } from 'jimu-ui'
// Only used as type.
...
export const DataUrlInput = (props: UrlInputProps) => {
  ...
  const translate = hooks.useTranslate(jimuCoreMessages, jimuUIMessages, defaultMessages)
  ...
  return <div className='data-url-input w-100 h-100 p-3' css={style}>
    ...
    <div className='mt-3'>
      ...
      <UrlInput className={classNames({ 'with-error': !urlResult.valid })} height={80} schemes={SupportedSchemes} value={urlResult.value} checkValidityOnChange={checkUrl} checkValidityOnAccept={checkUrl} onChange={onUrlChange} />
    </div>
