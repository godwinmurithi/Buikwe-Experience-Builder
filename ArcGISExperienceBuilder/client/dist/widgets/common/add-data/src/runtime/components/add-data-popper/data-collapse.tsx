/** @jsx jsx */
import { React, ReactRedux, jsx, css, IMDataSourceJson, Immutable, i18n, dataSourceUtils, IMState, DataSourceStatus } from 'jimu-core'
import { hooks, Button, defaultMessages as jimuUIMessages, Icon, Alert, Loading, LoadingType } from 'jimu-ui'
...
export const DataCollapse = (props: DataCollapseProps) => {
  ...
  const translate = hooks.useTranslate(jimuUIMessages)
  ...
  return <div className='data-collapse' css={style}>
    {
      ...
      <div className='data-container surface-2 p-3'>
        <div className='d-flex justify-content-between align-items-center'>
          <div className='d-flex align-items-center n-selected'>
            ...
            <Button type='tertiary' size='sm' icon onClick={toggleCollapse} title={isCollapseOpen ? translate('down') : translate('up')} >
              {
...
function DataItem ({ dsJson, isLoading, onRemove }: { dsJson: IMDataSourceJson, isLoading: boolean, onRemove: (dsId: string) => void }) {
  ...
  return <div className='d-flex align-items-center justify-content-between w-100 data-item'>
