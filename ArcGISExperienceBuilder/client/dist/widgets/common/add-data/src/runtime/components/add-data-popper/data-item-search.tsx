/** @jsx jsx */
import { React, jsx, css, SupportedItemTypes as JimuSupportedItemTypes, Immutable, DataSourceJson, dataSourceUtils, ReactRedux, IMState, DataSourceStatus, ServiceManager, SupportedLayerServiceTypes } from 'jimu-core'
import { IItemWithPortalUrl, ItemSelector, ItemSelectorMode } from 'jimu-ui/basic/item-selector'
...
export const DataItemSearch = (props: DataItemSearchProps) => {
  const { widgetId, multiDataOptions, portalUrl, nextOrder, onChange } = props
  ...
  return <div className='data-item-search w-100 h-100' css={style}>
    <ItemSelector mode={ItemSelectorMode.Simple} itemType={SupportedItemTypes} portalUrl={portalUrl} isMultiple={true} onSelect={onSelect} onRemove={onRemove} selectedItems={selectedItems} loadingItems={loadingItems} disableDetailPopper allowAllSceneService />
  </div>
}
