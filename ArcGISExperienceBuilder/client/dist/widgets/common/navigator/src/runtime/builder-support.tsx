/** @jsx jsx */
import { jsx, css, polished, lodash, Immutable, ImmutableArray, WidgetInitResizeCallback, WidgetInitDragCallback } from 'jimu-core'
...
export const NavQuickStyle = (props: NavQuickStyleProps) => {
  ...
  return <QuickStylePopper {...others} css={style} trapFocus={false} autoFocus={false}>
    <div className="body">
      {
