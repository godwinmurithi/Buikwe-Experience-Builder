/**@jsx jsx */
import { React, jsx, ReactRedux, IMState, appActions, getAppStore, Size, Immutable, WidgetState, css, LayoutItemConstructorProps, BrowserSizeMode } from 'jimu-core'
...
export const Builder = (props: BuilderProps) => {
  ...
  React.useEffect(() => {
    if (showWidgetsPanel && browserSizeMode === BrowserSizeMode.Small) {
      appBuilderSync.letBuilderShowPopperSelector('widget', {
        isPlaceholder: false,
  ...
  return <div className='controller-builder w-100 h-100' ref={rootRef} onClick={handleRootClick}>
    ...
    {showWidgetsPanel && browserSizeMode !== BrowserSizeMode.Small && <WidgetListPopper
