import {
  AbstractMessageAction, MessageType, Message, DataSourcesChangeMessage, DataSourcesChangeType, MutableStoreManager,
  getAppStore, ImmutableObject, JimuMapViewInfo, MessageDescription, DataSource, DataSourceTypes, JSAPILayerMixin
} from 'jimu-core'
import { ADD_TO_MAP_DATA_ID_PREFIX, ActionType, AddToMapDatas, DataChangeType, MapViewManager } from 'jimu-arcgis'
