...
import { MapViewManager, JimuMapView, JimuMapViewGroup, JimuMapViewComponent, DefaultMapInfo, ActionType, DataChangeType } from 'jimu-arcgis'
...
export default class MultiSourceMap extends React.PureComponent<Props, State> {
  ...
  isShowClearShowOnMapDataBtn = () => {
    ...
    const addToMapDatas = this.props.baseWidgetProps.mutableStateProps?.addToMapDatas || {}
    ...
    return showOnMapDataInfos.concat(addToMapDataInfos).some(dataInfo => {
      ...
      return (jimuMapViewId === this.state.currentJimuMapViewId && dataInfo.type === ActionType.DataAction && dataInfo.needToRemove)
    })
  }
