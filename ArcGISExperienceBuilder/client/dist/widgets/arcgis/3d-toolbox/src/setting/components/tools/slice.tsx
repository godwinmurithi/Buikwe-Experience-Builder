/** @jsx jsx */
import { React, jsx, UseDataSource, ImmutableArray } from 'jimu-core'
import { hooks, Switch, Button, defaultMessages as jimuUIMessages } from 'jimu-ui'
import defaultMessages from '../../translations/default'
import { SettingSection, SettingRow } from 'jimu-ui/advanced/setting-components'
import { Tool3D, SliceConfig } from '../../../constraints'
...
export const Slice = React.memo((props: Props) => {
  ...
  <React.Fragment>
    <SettingSection className='first-setting-section'>
      {/* tiltEnabled */}
      <SettingRow label={translate('tiltEnabled')}>
      ...
      <SettingRow label={translate('excludeGroundSurface')}>
      ...
      {/* default slice */}
      <SettingRow label={translate('defaultSlice')}>
        <Button type='tertiary' icon={true} onClick={() => { setShownMapPopperState(true) }}>{<EditOutlined />}</Button>
      </SettingRow>
