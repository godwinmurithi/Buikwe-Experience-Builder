...
import { hooks, Button, defaultMessages as jimuUIMessages } from 'jimu-ui'
import { JimuMapView } from 'jimu-arcgis'
import defaultMessages from '../../../translations/default'
import { sliceAnalysisInfo } from '../../../../constraints'
...
interface Props {
  ...
  //
  setPresetAnalysisInConfig: ((analysisInfo: sliceAnalysisInfo) => void)
  clearPresetAnalysisInConfig: (() => void)
