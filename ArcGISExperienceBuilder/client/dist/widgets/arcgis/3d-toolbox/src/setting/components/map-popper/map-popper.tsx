/** @jsx jsx */
import { UseDataSource, React, jsx, ImmutableArray, Immutable, getAppStore } from 'jimu-core'
import { hooks, FloatingPanel, defaultMessages as jimuUIMessages } from 'jimu-ui'
...
export const MapPopper = React.memo((props: Props) => {
  ...
  const SliceRef = React.useRef<__esri.SliceConstructor>(null) //__esri.Slice
  const SliceViewModelRef = React.useRef<__esri.SliceViewModelConstructor>(null) //__esri.SliceViewModel
