...
import { SliceConfig, sliceAnalysisInfo } from '../constraints'
...
export const useSliceAnalysis = (props: SliceAnalysisProps) => {
  ...
  const setPresetAnalysisInConfig = React.useCallback((analysisInfo: sliceAnalysisInfo) => {
  ...
  const clearPresetAnalysisInConfig = React.useCallback(() => {
