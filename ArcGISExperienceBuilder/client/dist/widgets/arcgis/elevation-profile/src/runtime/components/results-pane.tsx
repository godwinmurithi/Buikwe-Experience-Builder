...
export default class ResultPane extends React.PureComponent<Props, IState> {
  ...
  componentDidUpdate = (prevProps: Props) => {
    ...
    if (prevProps.activeDatasourceConfig?.profileChartSettings.showVolumetricObjLineInGraph !== this.props.activeDatasourceConfig?.profileChartSettings.showVolumetricObjLineInGraph ||
      prevProps.activeDatasourceConfig?.profileChartSettings.volumetricObjLineColor !== this.props.activeDatasourceConfig?.profileChartSettings.volumetricObjLineColor ||
      prevProps.activeDatasourceConfig?.profileChartSettings.volumetricObjLabel !== this.props.activeDatasourceConfig?.profileChartSettings.volumetricObjLabel) {
      this.setState({
        showViewLineGraph: this.props.activeDatasourceConfig?.profileChartSettings.showVolumetricObjLineInGraph,
        volumetricObjLineColor: this.props.activeDatasourceConfig?.profileChartSettings.volumetricObjLineColor,
        volumetricObjLabel: this.props.activeDatasourceConfig?.profileChartSettings.volumetricObjLabel
      })
    }
