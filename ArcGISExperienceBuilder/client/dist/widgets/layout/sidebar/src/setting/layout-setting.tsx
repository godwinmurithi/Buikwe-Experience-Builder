      ...
      <div className='hsidebar-layout-setting' css={this.getStyle()}>
        <SettingSection title={formatMessage('panel')} role='group' aria-label={formatMessage('panel')}>
          ...
          <SettingRow label={formatMessage('size')}>
            <InputUnit aria-label={formatMessage('size')} min={0} units={availableUnits} value={uiUtils.stringOfLinearUnit(config.size)} style={inputStyle} onChange={this.updateSize} />
          </SettingRow>
        ...
        >
          <Collapse isOpen={config.toggleBtn.visible}>
            ...
            <SettingRow label={formatMessage('width')}>
              <NumericInput aria-label={formatMessage('width')} min={0} size='sm' style={inputStyle} value={config.toggleBtn.width} onChange={this.updateControllerWidth} />
            </SettingRow>
            <SettingRow label={formatMessage('height')}>
              <NumericInput aria-label={formatMessage('height')} min={0} size='sm' style={inputStyle} value={config.toggleBtn.height} onChange={this.updateControllerHeight} />
            </SettingRow>
