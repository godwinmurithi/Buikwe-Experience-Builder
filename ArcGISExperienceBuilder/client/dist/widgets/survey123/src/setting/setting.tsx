...
import { MapWidgetSelector, SettingSection, SettingRow, JimuLayerViewSelectorDeprecated } from 'jimu-ui/advanced/setting-components'
                  ...
                  ? <React.Fragment>
                    ...
                    <SettingRow className="fea-layer-outter">
                      ...
                      <div className="feature-layer-dropdown">
                        <JimuLayerViewSelectorDeprecated aria-label={this.nls('selectSourceLayer')} onSelect={this.onDataSourceSelected} useMapWidgetIds={this.state.useMapWidgetIdsInNewMode}
                ...
                <SettingRow className="fea-layer-outter">
                  <div id={`survey_${this.props.id}_selectSurveyLayerForEditMode`}>
                    ...
                    <div className="feature-layer-dropdown" title={this.nls('selectSurveyLayerTip')}>
                      <JimuLayerViewSelectorDeprecated onSelect={this.onDataSourceSelected} useMapWidgetIds={this.state.useMapWidgetIdsInEditMode}
              ...
              ? <React.Fragment>
                ...
                <SettingRow className="fea-layer-outter">
                  <div id={`survey_${this.props.id}_selectMapForVIewMode`}>
                    ...
                    <div className="feature-layer-dropdown" title={this.nls('selectSurveyLayerTip')}>
                      <JimuLayerViewSelectorDeprecated onSelect={this.onDataSourceSelected} useMapWidgetIds={this.state.useMapWidgetIdsInViewMode}
